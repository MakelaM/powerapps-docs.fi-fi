...
Vieraile [PowerAppsin hinnoittelusivulla][2] saadaksesi kaikkien PowerApps-käyttöoikeuksien uusimmat hintatiedot.
Vieraile [Microsoft Flow:n hinnoittelusivulla][1] saadaksesi kaikkien Microsoft Flow -käyttöoikeuksien uusimmat hintatiedot.
...
| --- | --- |
| **Luo ja suorita sovelluksia** | |
| Suorita sovelluksia |Kyllä |
| Luo sovelluksia |Ei |
| Jaa sovelluksia |Ei |
| **Kapasiteetti** | |
...
| Luo mukautettuja liittimiä omissa järjestelmissäsi olevien tietojen hallitsemista varten |Ei |
| **Common Data Service** | |
| Luo ja suorita sovelluksia Common Data Servicessä |Ei |
| Mallinna tietojasi Common Data Servicessä |Ei |
| Luo tietokanta Common Data Servicessä |Ei |
| **Hallinta** | |
...
| Muodosta ympäristöjen tietokäytäntöjä |Ei |
...
* Microsoft PowerApps-palvelupaketti 2:n tilaukset on tarkoitettu käyttäjille ja järjestelmänvalvojille, jotka tarvitsevat täydet ominaisuudet sovellusten luomista ja suorittamista varten. Näillä käyttäjillä on pääsy tärkeisiin hallintaominaisuuksiin, kuten käyttötietojen tarkasteluun ja käytäntöjen määrittelyyn. PowerAppsin palvelupaketti 2:n käyttäjät voivat mallintaa tietoja Common Data Servicessä.
* Microsoft PowerAppsin palvelupaketti 1:n tilaukset on tarkoitettu käyttäjille, jotka pääasiassa suorittavat sovelluksia. Nämä käyttäjät voivat kuitenkin luoda sovelluksia ja työnkulkuja, mutta he eivät voi mallintaa tietoja Common Data Servicessä tai suorittaa hallintatehtäviä.

### <a name="powerapps-plan-2-free-trial"></a>PowerAppsin palvelupaketin 2 maksuton kokeiluversio
PowerApps ei tarjoa maksutonta tiliä, mutta käyttäjät voivat kokeilla PowerAppsin palvelupaketti 2:ta maksutta 90 päivää. Kokeilujakson aikana käyttäjät voivat käyttää PowerAppsin palvelupaketti 2:n kaikkia toimintoja. Lisätietoja rekisteröitymisestä on kohdassa [PowerAppsin omatoiminen rekisteröinti][3].
...
* PowerAppsin palvelupaketti 2 – 10 käyttöoikeutta: 10 IT-järjestelmänvalvojaa, jotka määrittävät yritykselle ympäristöt sovelluksen testaamista ja käyttöönottoa varten, mallintavat tietoja Common Data Servicessä ja laativat tietoturvakäytännöt, tarvitsevat kukin oman PowerApps -palvelupaketti 2:n näiden toimenpiteiden suorittamista varten.
* PowerApps palvelupaketti 1 – 990 lisenssiä: 700 Office 365:n käyttäjää tarvitsee PowerApps palvelupaketti 1:n, koska sovellus käyttää Officen ulkopuolelle tallennettuja tietoja (siis Common Data Serviceen tallennettuja tietoja). Muut 290 käyttäjää, joilla ei ole Office 365:n tai PowerAppsin palvelupaketti 2:n käyttöoikeutta, tarvitsevat käyttöoikeuden saadakseen oikeudet sovelluksen suorittamiseen.
