...
2. Valitse **Tyhjä sovellus** -ruudun **Luo sovellus** -kohdassa **puhelinasettelu**.
   ...
   * *Kaava*:  Tälle ominaisuudelle laskettava kaava muodostuu [arvoista, operaattoreista ja funktioista](formula-reference.md).
...
Excelissä voit kirjoittaa **= A1 + A2** näkyy summa solujen arvoista soluun **A1** ja **A2** sisältää. Jos jompikumpi tai molemmat näistä arvoista muuttuu, kaavan sisältävä solu näyttää automaattisesti päivitetyn tuloksen.

![Animaatio Excelin kahden luvun summa lasketaan uudelleen](./media/working-with-formulas/excel-recalc.gif)

Powerappsissa voit saavuttaa samanlaisen tuloksen lisäämällä ohjausobjekteja näyttöön ja määrittämällä niiden ominaisuudet. Tässä esimerkissä näytetään otsikko-ohjausobjektin nimeltä **Label1** ja kaksi **[Tekstisyöte](controls/control-text-input.md)** ohjausobjektia nimeltä **TextInput1** ja  **TextInput2**.

![Kuva kahden luvun summa lasketaan uudelleen PowerApps](./media/working-with-formulas/recalc1.png)
...
![Animaation Powerappsiin uudelleenlaskeminen lukujen summan](./media/working-with-formulas/recalc2.gif)

Excelissä voit käyttää kaavoja ehdollista muotoilua näyttämään esimerkiksi negatiiviset arvot punaisella. PowerAppsissa voidaan käyttää kaavoja määrittämään ohjausobjektin ensisijaisen arvon lisäksi myös ominaisuuksia, kuten muotoilun. Seuraavassa esimerkissä kaava **[väri](controls/properties-color-border.md)** ominaisuudeksi näyttää negatiiviset arvot automaattisesti punaisella. **[If](functions/function-if.md)**-funktio näyttää hyvin tutulta Excelistä:
