...
**ColorFade**-funktio palauttaa värin sävyn kirkkaampana tai tummempana. Häivytyksen määrän asetusalue 1 tai-100 % (joka tummentaa värin mustaksi) 0 (joka ei vaikuta väri) 1 eli 100 % (joka kirkastaa värin valkoinen kokonaan).
...
* *FadeAmount* – Pakollinen.  Luku väliltä –1 ja 1.  –1 tummentaa värin kokonaan mustaksi, 0 ei vaikuta väriin ja 1 kirkastaa värin kokonaan valkoiseksi. Voit myös käyttää-100 prosenttiarvo % 100 %
