...
* Yhdistetyt [tietolähteet](../working-with-data-sources.md), kuten SQL Server, voivat käyttää tyhjäarvoja. Nämä arvot näytetään *tyhjinä* PowerAppsissa.
