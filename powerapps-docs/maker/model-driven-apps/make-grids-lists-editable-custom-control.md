...
Seuraavia tietotyyppejä ei voi muokata muokattavissa ruudukoissa: Asiakas- ja Osapuoliluettelo-hakukentät; Yhdistelmä (osoite) -kentät; Tila-kentät; Entiteettiin liittyvät hakukentät (esimerkiksi Asiakas-entiteetti sisältää yhteyshenkilöhaun, jossa Yhteyshenkilö-kenttää voi muokata EmailAddress(Contact)-kenttää ei).  
