---
title: Muotoilun ohjelmointi raja pinta komponentti | Microsoft Docs
description: ''
keywords: ''
ms.author: nabuthuk
author: Nkrb
...
ms.locfileid: "72340433"
---
# <a name="implementing-formatting-api-component"></a>Muotoilun ohjelmointi raja pinta komponentin toteuttaminen

Tämä malli komponentti tutkii eri menetelmiä, jotka ovat käytettävissä osana PowerApps Component Framework-ohjelmointi raja pintaa. Tässä esimerkissä luot sarjan syöte elementtejä, jotka kutsut muotoilun ohjelmointi raja pinnan vastaavaan metodiin, joka vastaa näytettävää arvoa.

> [!div class="mx-imgBorder"]
> ![Muotoilun ohjelmointi raja pinta komponentin](../media/formatting-api.png "muotoilun ohjelmointi raja pinta komponentti")
