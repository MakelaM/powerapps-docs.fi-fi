---
title: " Lisäys komponentti | Microsoft Docs"
description: Lisäys osan toteuttaminen
ms.custom: ''
manager: kvivek
ms.date: 10/01/2019
...
ms.locfileid: "72340180"
---
# <a name="implementing-increment-component"></a>Toteutetaan lisäys osaa

Tässä esimerkki osassa näytetään, miten tietoja sidotaan PowerApps Component Frameworkin ja virheiden käsittelyn avulla. Tämä osa muodostaa teksti ruudun, jossa on suoritus palvelun `Increment` painike. Teksti ruudussa näkyy nykyinen arvo, ja `Increment` painiketta on napsautettavissa. Kun napsautat painiketta, teksti ruudun arvoa suurennetaan luvulla 1. Lisäys arvo voidaan muuttaa mihin tahansa numeroon haluat.

Jotta voit ottaa tämän osan käyttöön, sinun on ensin määritettävä [luettelo](../manifest-schema-reference/manifest.md) tiedosto ja otettava sitten mukautettu logiikka käyttöön TypeScript-kohteessa.

> [!div class="mx-imgBorder"]
> ![Increment Component]-(../media/increment-control.png "lisäys komponentti")
...
Kun napsautat painiketta, teksti ruudun arvoa suurennetaan luvulla 1. Päivitetty arvo virtaa PowerApps Component Frameworkin kautta `notifyOutputChanged` menetelmällä.

> [!NOTE]
> Voit muuttaa lisäys arvoa, kun määrität komponenttia lomakkeen-kenttään.

Muokkaa teksti ruudun arvoa ja jos se on kelvollinen kokonaisluku, se päivittää arvon PowerApps Component Framework. Voit jatkuvasti napsauttaa `Increment`-painiketta ja päivittää sen. Jos se on virheellinen kokonaisluku, näyttöön tulee virhe sanoma.
