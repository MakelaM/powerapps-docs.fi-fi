---
title: Ohjaus objektin tilan ohjelmointi raja pinta | Microsoft Docs
description: ''
...
ms.locfileid: "72340525"
---
# <a name="implementing-control-state-api-component"></a>Ohjaus objektin tilan ohjelmointi raja pinnan osan toteutus

PowerApps-komponentti kehyksen avulla voit jatkaa osan tilaa useissa saman istunnon aikana. Sen avulla voit luoda komponentteja, jotka voivat ylläpitää käyttäjä tilaa käyttäjän istunnon aikana, kun käyttäjä siirtyy-osaan ja-osasta.

Jos koodi komponenttiasi on esimerkiksi pitkä lista, jota käyttäjä voi vierittää, voit hyödyntää **_Setcontrolstate_** -toimintoa ja muistaa sen luettelossasi olevan kohdan, jota käyttäjä tarkastelee, kun hän on siirtynyt pois lomakkeesta. Voit sitten lisätä komponentin alustamisen logiikan, joka tarkistaa tallennetun tilan ja hahmontaa komponentin kohteen siinä kohdassa, jossa käyttäjä oli aiemmin lukenut.

> [!div class="mx-imgBorder"] 
> ![Ohjaus objektin tilan ohjelmointi raja pinnan](../media/control-state-api.png "hallinnan tilan ohjelmointi raja pinta")
